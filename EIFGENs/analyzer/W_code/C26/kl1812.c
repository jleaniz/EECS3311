...
extern EIF_TYPED_VALUE F1812_20267(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1812_20267 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1811, Current, 0, 0, 26351);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1811, Current, 26351);
	RTIV(Current, RTAL);
	RTHOOK(1);
