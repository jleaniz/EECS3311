...
extern EIF_TYPED_VALUE F1832_20687(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1832_20688(EIF_REFERENCE);
extern void F1832_20689(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1832_20687 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1832_20688 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1832_20689 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1831, Current, 0, 0, 26713);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1831, Current, 26713);
	RTIV(Current, RTAL);
