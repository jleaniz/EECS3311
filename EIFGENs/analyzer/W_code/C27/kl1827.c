...
extern void F1827_20655(EIF_REFERENCE);
extern void F1827_20656(EIF_REFERENCE);
...
void F1827_20655 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1826, Current, 0, 0, 26685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1826, Current, 26685);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1827_20656 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1826, Current, 0, 0, 26686);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1826, Current, 26686);
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(17207, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
