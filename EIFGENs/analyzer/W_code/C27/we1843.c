...
extern EIF_TYPED_VALUE F1843_20801(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1843_20801 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1842, Current, 0, 0, 26825);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1842, Current, 26825);
	RTIV(Current, RTAL);
	RTHOOK(1);
