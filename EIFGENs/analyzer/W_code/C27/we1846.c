...
extern EIF_TYPED_VALUE F1846_20823(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1846_20823 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1845, Current, 0, 0, 26847);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1845, Current, 26847);
	RTIV(Current, RTAL);
	RTHOOK(1);
