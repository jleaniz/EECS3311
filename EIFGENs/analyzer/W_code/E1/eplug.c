...
void egc_init_plug (void)
{
	...
	egc_system_name = "analyzer";
	egc_system_location = "C:\\Users\\Juan Leaniz\\Downloads\\3311\\analyzer\\EIFGENs\\analyzer\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1574788803;
