...
extern EIF_TYPED_VALUE F1222_12713(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1222_12714(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1222_12715(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1222_12713 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1222_12714 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1222_12715 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1221, Current, 0, 0, 18971);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1221, Current, 18971);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(10432, "fractional_second", tr1));
