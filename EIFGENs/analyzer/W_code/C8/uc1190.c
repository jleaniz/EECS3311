...
extern EIF_TYPED_VALUE F1190_12122(EIF_REFERENCE);
...
RTOID (F1190_12122)
EIF_TYPED_VALUE F1190_12122 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1189, Current, 0, 0, 18405);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1189, Current, 18405);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
