...
extern EIF_TYPED_VALUE F1926_23103(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1926_23104(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1926_23103 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1925, Current, 0, 0, 29045);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1925, Current, 29045);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9854, dtype))(Current)).it_i4);
	ui4_1 = ti4_2;
	ti4_2 = eif_bit_or(ti4_1,ui4_1);
...
EIF_TYPED_VALUE F1926_23104 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1925, Current, 0, 0, 29046);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1925, Current, 29046);
	RTIV(Current, RTAL);
	RTHOOK(1);
