...
extern void F1347_14226(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1347_14227(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1347_14228(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void EIF_Minit1347(void);
extern EIF_REFERENCE _A1347_183();
...
void F1347_14226 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1346, Current, 0, 1, 20643);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1346, Current, 20643);
	{
		...
		RTCC(arg1, 1346, l_feature_name, 1, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = NULL;
...
void F1347_14227 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1346, Current, 0, 1, 20644);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1346, Current, 20644);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,250,0xFF01,0xFFF9,0,186,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1347_183, (EIF_POINTER)(0),11787, 0, 0, 1, -1, tr1, 0);
	}
	ur1 = RTCCL(tr2);
...
EIF_TYPED_VALUE F1347_14228 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1346, Current, 0, 1, 20645);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1346, Current, 20645);
	RTIV(Current, RTAL);
