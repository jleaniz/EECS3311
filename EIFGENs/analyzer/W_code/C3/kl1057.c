...
extern EIF_TYPED_VALUE F1057_10134(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1057_10135(EIF_REFERENCE);
...
RTOID (F1057_10134)
EIF_TYPED_VALUE F1057_10134 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1056, Current, 0, 0, 16478);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1056, Current, 16478);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F1057_10135)
EIF_TYPED_VALUE F1057_10135 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1056, Current, 0, 0, 16479);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1056, Current, 16479);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (10134,F1057_10134)
	RTOTS (10135,F1057_10135)
}
