...
extern EIF_TYPED_VALUE F1037_9959(EIF_REFERENCE);
extern void F1037_25557(EIF_REFERENCE, int);
...
/* {ETF_MODEL_ACCESS}.m */
RTOID (F1037_9959)
EIF_TYPED_VALUE F1037_9959 (EIF_REFERENCE Current)
{
	GTCX
...
void F1037_25557 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1036, Current, 0, 25556);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
