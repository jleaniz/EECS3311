...
extern EIF_TYPED_VALUE F1041_9972(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1041_9973(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1041_9974(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1041_9975(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1041_9976(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1041_9972 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1040, Current, 0, 0, 16319);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1040, Current, 16319);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1041_9973 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1040, Current, 0, 0, 16320);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1040, Current, 16320);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1041_9974 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1040, Current, 0, 0, 16321);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1040, Current, 16321);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1041_9975 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1040, Current, 0, 0, 16322);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1040, Current, 16322);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1041_9976 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1040, Current, 0, 1, 16323);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1040, Current, 16323);
	RTIV(Current, RTAL);
	RTHOOK(1);
