...
extern EIF_TYPED_VALUE F1056_10133(EIF_REFERENCE);
...
RTOID (F1056_10133)
EIF_TYPED_VALUE F1056_10133 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1055, Current, 0, 0, 16477);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 16477);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
