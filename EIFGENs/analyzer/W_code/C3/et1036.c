...
extern void F1036_9955(EIF_REFERENCE);
extern void F1036_9956(EIF_REFERENCE);
extern void F1036_9957(EIF_REFERENCE);
...
void F1036_9955 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1035, Current, 1, 0, 16299);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1035, Current, 16299);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(4);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(14977, "launch", loc1))(loc1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
void F1036_9956 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1035, Current, 0, 0, 16300);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1035, Current, 16300);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7743, 0xF800066B, 0); /* main_window */
	tr1 = RTLNSMART(RTWCT(7743, dtype, Dftype(Current)).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(32, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
	tr1 = RTCCL(tr1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(7743, dtype)) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F1036_9957 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1035, Current, 0, 0, 16301);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTNHOOK(1,1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(15225, "show", tr1))(tr1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
