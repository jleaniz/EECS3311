...
extern void F1706_19016(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1706_19017(EIF_REFERENCE);
extern void F1706_19018(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1706_19019(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1706_19020(EIF_REFERENCE);
extern void F1706_19021(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1706_19022_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1706_19022(EIF_REFERENCE);
...
void F1706_19016 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1705, Current, 0, 1, 25542);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1705, Current, 25542);
	RTCC(arg1, 1705, l_feature_name, 1, RTWCT(15672, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1706_19017 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1705, Current, 0, 0, 25543);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1705, Current, 25543);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1706_19018 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1705, Current, 0, 0, 25544);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1705, Current, 25544);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ub1 = (EIF_BOOLEAN) 1;
...
EIF_TYPED_VALUE F1706_19019 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1705, Current, 1, 0, 25545);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1705, Current, 25545);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9271, dtype))(Current, ur1x);
	RTHOOK(2);
	...
	if (tb1) {
		...
		RTHOOK(6);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9272, dtype))(Current);
	}
	RTHOOK(7);
...
EIF_TYPED_VALUE F1706_19020 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1705, Current, 0, 0, 25546);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1705, Current, 25546);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ur1 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9271, dtype))(Current, ur1x);
...
void F1706_19021 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1705, Current, 2, 1, 25547);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1705, Current, 25547);
	RTCC(arg1, 1705, l_feature_name, 1, eif_new_type(229, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(18339, "silly_main_window", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc2 = RTCCL(tr1);
	loc2 = RTRV(eif_new_type(1897, 0x00), loc2);
	RTHOOK(5);
	RTCT0("wel_window /= Void", EX_CHECK);
	...
	if (tb1) {
		RTHOOK(8);
		(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9273, dtype))(Current);
		RTHOOK(9);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = '\0';
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(15857, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(12,1);
		ur1 = RTCCL(arg1);
...
static EIF_TYPED_VALUE F1706_19022_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1705, Current, 0, 0, 25548);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1705, Current, 25548);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1706_19022 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(15672, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1706_19022_body (Current)).it_r;
