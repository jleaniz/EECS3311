...
extern EIF_TYPED_VALUE F1099_10629(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1099_10629 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1098, Current, 0, 0, 16972);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1098, Current, 16972);
	RTIV(Current, RTAL);
