...
extern EIF_TYPED_VALUE F1111_10702(EIF_REFERENCE);
...
RTOID (F1111_10702)
EIF_TYPED_VALUE F1111_10702 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1110, Current, 0, 0, 17027);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1110, Current, 17027);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000478, 0,0); /* Result */
