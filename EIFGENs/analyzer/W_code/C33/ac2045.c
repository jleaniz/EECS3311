...
extern void F2045_4189(EIF_REFERENCE);
extern void F2045_4190(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2045_4191(EIF_REFERENCE);
extern EIF_TYPED_VALUE F2045_4192(EIF_REFERENCE);
extern void F2045_4193(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F2045_4194(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F2045_4195(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F2045_7183(EIF_REFERENCE, int);
...
void F2045_4189 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 2044, Current, 0, 0, 20556);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2044, Current, 20556);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 3110, 0xF80003AB, 0); /* add_actions */
	...
	*(EIF_REFERENCE *)(Current + RTWA(3110, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 3111, 0xF80003AB, 0); /* remove_actions */
	...
	*(EIF_REFERENCE *)(Current + RTWA(3111, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(32, 941))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
	RTDBGLE;
...
void F2045_4190 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2044, Current, 0, 1, 20557);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2044, Current, 20557);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F2045_4191 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F2045_4192 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F2045_4193 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2044, Current, 1, 2, 20560);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2044, Current, 20560);
	RTCC(arg1, 2044, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F2045_4194 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2044, Current, 1, 2, 20561);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2044, Current, 20561);
	RTCC(arg1, 2044, l_feature_name, 1, RTWCT(2258, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F2045_4195 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 2044, Current, 0, 1, 20562);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(2044, Current, 20562);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAL(0, 0xF80007FC, 0,0); /* Result */
...
void F2045_7183 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 2044, Current, 0, 7182);
	RTSA(dtype);
	RTME(dtype, 0);
