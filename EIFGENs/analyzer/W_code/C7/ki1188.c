...
extern void F1188_12105(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1188_12105 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
body:;
	RTHOOK(3);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9870, dtype))(Current, ur1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
EIF_TYPED_VALUE F1188_12111 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1187, Current, 0, 0, 18404);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1187, Current, 18404);
	RTIV(Current, RTAL);
	RTHOOK(1);
