...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1183, Current, 0, 0, 18360);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1183, Current, 18360);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF800076B, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1183, Current, 0, 0, 18361);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1183, Current, 18361);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800039E, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,926,1899,0xFFFF};
		EIF_TYPE typres0;
