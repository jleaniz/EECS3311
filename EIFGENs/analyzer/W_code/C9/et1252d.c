...
static const struct desc_info desc_1252[] = {
	...
	{EIF_GENERIC(egt_9_1252), 19193, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_13_1252), 19172, 0},
	{EIF_GENERIC(NULL), 19173, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 19191, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B5 /*218*/), 19192, 8},
};
void Init1252(void)
{
	IDSC(desc_1252, 0, 1251);
	IDSC(desc_1252 + 1, 1, 1251);
	IDSC(desc_1252 + 32, 412, 1251);
	IDSC(desc_1252 + 34, 436, 1251);
}
