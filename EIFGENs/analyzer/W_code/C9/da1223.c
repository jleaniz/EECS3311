...
extern EIF_TYPED_VALUE F1223_12723(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1223_12723 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1222, Current, 0, 0, 18972);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1222, Current, 18972);
	RTIV(Current, RTAL);
	RTHOOK(1);
