...
extern EIF_TYPED_VALUE F1227_12857(EIF_REFERENCE);
...
RTOID (F1227_12857)
EIF_TYPED_VALUE F1227_12857 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1226, Current, 0, 0, 19106);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1226, Current, 19106);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
