...
static const EIF_TYPE_INDEX egt_13_1001 [] = {0xFF01,0xFFF9,2,186,206,206,0xFFFF};
...
static const struct desc_info desc_1001[] = {
	...
	{EIF_NON_GENERIC(0x01B5 /*218*/), 15478, 0xFFFFFFFF},
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 15482, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01C7 /*227*/), 15483, 0},
	{EIF_GENERIC(egt_13_1001), 15484, 0xFFFFFFFF},
	...
	{EIF_NON_GENERIC(0x01B5 /*218*/), 15489, 0xFFFFFFFF},
};
void Init1001(void)
{
	IDSC(desc_1001, 0, 1000);
	IDSC(desc_1001 + 1, 1, 1000);
	IDSC(desc_1001 + 32, 965, 1000);
}
