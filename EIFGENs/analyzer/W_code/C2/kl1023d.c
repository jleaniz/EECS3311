...
static const struct desc_info desc_1023[] = {
	...
	{EIF_NON_GENERIC(0x0197 /*203*/), 15990, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0197 /*203*/), 15991, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0197 /*203*/), 15992, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01 /*0*/), 15993, 0xFFFFFFFF},
};
void Init1023(void)
{
	IDSC(desc_1023, 0, 1022);
	IDSC(desc_1023 + 1, 1, 1022);
	IDSC(desc_1023 + 32, 732, 1022);
}
