...
extern EIF_TYPED_VALUE F1007_9228(EIF_REFERENCE);
extern void F1007_9230(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1007_9228 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1007_9230 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1006, Current, 0, 1, 15533);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1006, Current, 15533);
	if (arg1) {
		RTCC(arg1, 1006, l_feature_name, 1, eif_new_type(1838, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7015, 0xF800072E, 0); /* message_information */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
