...
extern EIF_TYPED_VALUE F1419_14607(EIF_REFERENCE);
...
RTOID (F1419_14607)
EIF_TYPED_VALUE F1419_14607 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1418, Current, 0, 0, 21179);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1418, Current, 21179);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
