...
extern EIF_TYPED_VALUE F973_8878(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F973_8878 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 972, Current, 0, 1, 15179);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(972, Current, 15179);
	RTIV(Current, RTAL);
	RTHOOK(1);
