...
static const EIF_TYPE_INDEX egt_13_972 [] = {0xFF01,270,0xFF01,962,0xFFFF};
static const EIF_TYPE_INDEX egt_14_972 [] = {0xFF01,171,0xFFFF};
...
static const struct desc_info desc_972[] = {
	...
	{EIF_GENERIC(egt_13_972), 15174, 0},
	{EIF_GENERIC(egt_14_972), 15175, 0xFFFFFFFF},
};
void Init972(void)
{
	IDSC(desc_972, 0, 971);
	IDSC(desc_972 + 1, 1, 971);
	IDSC(desc_972 + 32, 1276, 971);
}
