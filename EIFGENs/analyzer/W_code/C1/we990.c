/*
 * Code for class WEL_MA_CONSTANTS
 */
...
/* {WEL_MA_CONSTANTS}.ma_activateandeat */
...
/* {WEL_MA_CONSTANTS}.ma_noactivate */
...
/* {WEL_MA_CONSTANTS}.ma_noactivateandeat */
