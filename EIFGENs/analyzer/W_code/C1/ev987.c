...
extern void F987_8970(EIF_REFERENCE);
extern void F987_8971(EIF_REFERENCE);
extern void F987_8972(EIF_REFERENCE);
extern void F987_8973(EIF_REFERENCE);
extern void F987_8974(EIF_REFERENCE);
extern void F987_8975(EIF_REFERENCE);
extern EIF_TYPED_VALUE F987_8976(EIF_REFERENCE);
...
extern void F987_25553(EIF_REFERENCE, int);
...
void F987_8970 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 15272);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 15272);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F987_8971 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 15273);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 15273);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F987_8972 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 15274);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 15274);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(6765, dtype))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F987_8973 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6769, 0x10000000, 1); /* alignment_code */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6770, dtype))(Current)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(6769, dtype)) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("is_left_aligned", EX_POST);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6766, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F987_8974 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 15276);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(6769, dtype)) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6767, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F987_8975 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 15277);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6769, 0x10000000, 1); /* alignment_code */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6772, dtype))(Current)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(6769, dtype)) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("is_right_aligned", EX_POST);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6768, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F987_8976 (EIF_REFERENCE Current)
{
	GTCX
	...
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6769, dtype));
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6770, dtype))(Current)).it_i4);
...
EIF_TYPED_VALUE F987_8977 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 15279);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F987_8978 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 15280);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6769, dtype));
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6772, dtype))(Current)).it_i4);
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN)(ti4_1 == ti4_2);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
...
EIF_TYPED_VALUE F987_8979 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(6769,Dtype(Current)));
	return r;
}
...
void F987_25553 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 986, Current, 0, 25552);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("alignment_code_within_range", Current);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(6769, dtype));
	ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6770, dtype))(Current)).it_i4);
	ti4_3 = *(EIF_INTEGER_32 *)(Current + RTWA(6769, dtype));
	ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6772, dtype))(Current)).it_i4);
