...
#define up1 up1x.it_p
	...
	RTCC(arg1, 967, l_feature_name, 1, eif_new_type(993, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6597, 0xF80003E1, 0); /* guid */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(6597, dtype)) = (EIF_REFERENCE) tr1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
		RTCT("set", EX_POST);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 967, Current, 2, 0, 15109);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
