...
extern EIF_TYPED_VALUE F1144_11418(EIF_REFERENCE);
...
RTOID (F1144_11418)
EIF_TYPED_VALUE F1144_11418 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1143, Current, 0, 0, 17735);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1143, Current, 17735);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
