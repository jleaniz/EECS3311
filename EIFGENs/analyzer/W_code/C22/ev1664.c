...
extern EIF_TYPED_VALUE F1664_18577(EIF_REFERENCE);
extern void F1664_18578(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1664_18577 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1664_18578 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1663, Current, 0, 0, 25223);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1663, Current, 25223);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14794, 0xF80006F4, 0); /* implementation */
	tr1 = RTLN(eif_new_type(1990, 0x01).id);
