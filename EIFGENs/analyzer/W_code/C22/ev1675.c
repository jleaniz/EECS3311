...
extern EIF_TYPED_VALUE F1675_18630(EIF_REFERENCE);
extern void F1675_18631(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1675_18629 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1674, Current, 0, 0, 25273);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1675_18630 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1675_18631 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1674, Current, 0, 0, 25272);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14794, 0xF80006FB, 0); /* implementation */
	tr1 = RTLN(eif_new_type(1997, 0x01).id);
