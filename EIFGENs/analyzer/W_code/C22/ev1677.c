...
extern EIF_TYPED_VALUE F1677_18635(EIF_REFERENCE);
extern void F1677_18636(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1677_18635 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1677_18636 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1676, Current, 0, 0, 25279);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1676, Current, 25279);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 14794, 0xF80006FD, 0); /* implementation */
	tr1 = RTLN(eif_new_type(1998, 0x01).id);
