...
extern EIF_TYPED_VALUE F1855_21023(EIF_REFERENCE);
...
RTOID (F1855_21023)
EIF_TYPED_VALUE F1855_21023 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F1855_21023);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1854, Current, 0, 0, 27000);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1854, Current, 27000);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
