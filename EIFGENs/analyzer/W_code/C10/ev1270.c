...
/* {EV_ID_IMP}.make_id */
void F1270_13080 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1269, Current, 0, 0, 19328);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1269, Current, 19328);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1269, Current, 0, 0, 19326);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1269, Current, 19326);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F1270_25563 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1269, Current, 0, 25562);
	RTSA(dtype);
	RTME(dtype, 0);
