...
extern void F1283_13250(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1283_13251(EIF_REFERENCE);
...
void F1283_13250 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1282, Current, 0, 2, 19481);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1282, Current, 19481);
	RTCC(arg1, 1282, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	{
		...
		RTCC(arg2, 1282, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10931, 0xF8000383, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
void F1283_13251 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1282, Current, 3, 0, 19482);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1282, Current, 19482);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
...
EIF_TYPED_VALUE F1283_13252 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1282, Current, 0, 0, 19483);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1282, Current, 19483);
	RTIV(Current, RTAL);
	RTHOOK(1);
