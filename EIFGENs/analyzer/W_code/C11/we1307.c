...
extern EIF_TYPED_VALUE F1307_13918(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1307_13919(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1307_13920(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1307_13918 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1307_13919 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1307_13920 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1306, Current, 0, 1, 20147);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1306, Current, 20147);
	RTIV(Current, RTAL);
	RTHOOK(1);
