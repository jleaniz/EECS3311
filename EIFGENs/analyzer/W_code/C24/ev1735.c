...
extern EIF_TYPED_VALUE F1735_19485(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1735_19486(EIF_REFERENCE);
extern void F1735_19487(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1735_19488(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1735_19489(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1735_19485 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1734, Current, 1, 0, 25907);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1734, Current, 25907);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1735_19486 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "pixmap_imp";
	RTEX;
	EIF_REFERENCE loc1 = (EIF_REFERENCE) 0;
	EIF_TYPED_VALUE up1x = {{0}, SK_POINTER};
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1734, Current, 1, 0, 25908);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1734, Current, 25908);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16250, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
	if (EIF_TEST(loc1)) {
		...
		Result = RTCCL(tr1);
		Result = RTRV(eif_new_type(1278, 0x00), Result);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
void F1735_19487 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1734, Current, 0, 1, 25909);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1734, Current, 25909);
	RTCC(arg1, 1734, l_feature_name, 1, eif_new_type(1650, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F1735_19488 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1734, Current, 0, 0, 25910);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1734, Current, 25910);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16250, 0xF8000672, 0); /* private_pixmap */
...
/* {EV_PIXMAPABLE_IMP}.private_pixmap */
EIF_TYPED_VALUE F1735_19489 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(16250,Dtype(Current)));
	return r;
}
