...
extern EIF_TYPED_VALUE F1737_19497(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1737_19497 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1736, Current, 0, 0, 25913);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1736, Current, 25913);
	RTIV(Current, RTAL);
	RTHOOK(1);
