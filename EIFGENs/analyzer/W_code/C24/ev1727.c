...
extern EIF_TYPED_VALUE F1727_19458(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1727_19459(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1727_19460(EIF_REFERENCE);
extern void F1727_19461(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1727_19462(EIF_REFERENCE);
extern void F1727_19463(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1727_19458 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1726, Current, 2, 0, 25888);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1726, Current, 25888);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80003A1, 0,0); /* Result */
	{
		EIF_TYPE_INDEX typarr0[] = {0xFF01,929,0xFF01,0,0,0xFFFF};
		EIF_TYPE typres0;
		{
			EIF_TYPE l_type;
	...
	if (EIF_TEST(loc2)) {
		...
		if (RTAL & CK_CHECK) {
			...
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16225, dtype))(Current)).it_b);
			if (tb2) {
				RTCK;
			} else {
				RTCF;
...
EIF_TYPED_VALUE F1727_19459 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1726, Current, 3, 0, 25889);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1726, Current, 25889);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(16229, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc3 = RTCCL(tr1);
	if (EIF_TEST(loc3)) {
		...
		for (;;) {
			RTHOOK(4);
			tb1 = '\01';
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2291, "off", loc3))(loc3)).it_b);
			if (!tb2) {
			...
			RTNHOOK(5,1);
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(16225, "is_selected", tr1))(tr1)).it_b);
			if (tb2) {
				RTHOOK(6);
				RTDBGAL(2, 0xF800064A, 0, 0); /* loc2 */
				tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2258, "item", loc3))(loc3)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
				RTNHOOK(6,1);
				tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(15672, "interface", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
EIF_TYPED_VALUE F1727_19460 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(16229,Dtype(Current)));
	return r;
}


/* {EV_RADIO_PEER_IMP}.set_radio_group */
void F1727_19461 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1726, Current, 2, 1, 25891);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1726, Current, 25891);
	RTCC(arg1, 1726, l_feature_name, 1, RTWCT(16229, dtype, dftype), 0x00);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(5);
	ur1 = RTCCL(arg1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(16232, dtype))(Current, ur1x);
	RTHOOK(6);
...
void F1727_19462 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1726, Current, 1, 0, 25892);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1726, Current, 25892);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	RTHOOK(9);
	RTDBGAA(Current, dtype, 16229, 0xF80003A1, 0); /* radio_group */
	*(EIF_REFERENCE *)(Current + RTWA(16229, dtype)) = (EIF_REFERENCE) NULL;
	if (RTAL & CK_ENSURE) {
		RTHOOK(10);
...
void F1727_19463 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1726, Current, 0, 1, 25893);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1726, Current, 25893);
	RTCC(arg1, 1726, l_feature_name, 1, RTWCT(16229, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 16229, 0xF80003A1, 0); /* radio_group */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(16229, dtype)) = (EIF_REFERENCE) tr1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
